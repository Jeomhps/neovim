{
  ...
  # Always fetch the latest lze and lzextras directly from source
  inputs.plugins-lze = {
  ...
  outputs =
    ...
    let
      ...
      module = nixpkgs.lib.modules.importApply ./nvim/module.nix inputs;
    ...
    in
    {
      ...
      # home manager and nixos modules — enable with `wrappers.neovim.enable = true`
      nixosModules = {
